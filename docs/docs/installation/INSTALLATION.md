...
> If you are migrating an existing Data Center product, use the values of your product's database.
...
> If you are migrating an existing Data Center product, use the values of your product's shared home.
