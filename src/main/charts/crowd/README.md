...
![Version: 1.0.0](https://img.shields.io/badge/Version-1.0.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.3.5-jdk11](https://img.shields.io/badge/AppVersion-4.3.5--jdk11-informational?style=flat-square)
...
| schedulerName | string | `nil` | Standard K8s schedulerName that will be applied to all Crowd pods |
