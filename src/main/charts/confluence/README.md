...
![Version: 0.11.0](https://img.shields.io/badge/Version-0.11.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 7.12.2-jdk11](https://img.shields.io/badge/AppVersion-7.12.2--jdk11-informational?style=flat-square)
...
| synchrony.resources.container.requests.cpu | string | `"2"` |  |
| synchrony.resources.container.requests.memory | string | `"2.5G"` |  |
| synchrony.resources.jvm.maxHeap | string | `"2g"` | The maximum amount of heap memory that will be used by the Synchrony JVM |
| synchrony.resources.jvm.minHeap | string | `"1g"` | The minimum amount of heap memory that will be used by the Synchrony JVM |
