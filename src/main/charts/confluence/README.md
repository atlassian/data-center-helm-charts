...
![Version: 0.15.0](https://img.shields.io/badge/Version-0.15.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 7.12.4-jdk11](https://img.shields.io/badge/AppVersion-7.12.4--jdk11-informational?style=flat-square)
...
| confluence.additionalJvmArgs[0] | string | `"-XX:ActiveProcessorCount=2"` |  for 'container.requests.cpu'. https://docs.oracle.com/en/java/javase/11/tools/java.html#GUID-3B1CE181-CD30-4178-9602-230B800D4FAE |
...
| confluence.license | object | `{"secretKey":"license-key","secretName":null}` |    |
...
| fluentd | object | `{"command":null,"customConfigFile":false,"elasticsearch":{"enabled":true,"hostname":"elasticsearch","indexNamePrefix":"confluence"},"enabled":false,"extraVolumes":[],"fluentdCustomConfig":{},"httpPort":9880,"imageName":"fluent/fluentd-kubernetes-daemonset:v1.11.5-debian-elasticsearch7-1.2"}` |  Confluence log collection and aggregation can be enabled using Fluentd. This config assumes an existing ELK stack has been stood up and is available. https://www.fluentd.org/ |
