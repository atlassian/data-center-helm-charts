...
| confluence.topologySpreadConstraints | list | `[]` | Defines any topology spread constraints for the Confluence pod. All details: https://kubernetes.io/docs/concepts/workloads/pods/pod-topology-spread-constraints/ |
...
| synchrony.topologySpreadConstraints | list | `[]` | Defines any topology spread constraints for the Synchrony pod. All details: https://kubernetes.io/docs/concepts/workloads/pods/pod-topology-spread-constraints/ |
