...
| confluence.jvmDebug.enabled | bool | `false` | If set to `true`, Confluence JVM will be started in debug mode (on port 5005). Kuberneter port forwarding feature could be used to attach a debugger to the JVM. |
