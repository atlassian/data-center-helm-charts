...
| confluence.setPermissions | bool | `true` | Boolean to define whether to set home directory permissions on startup  of Confluence container. Set to 'false' to disable this behaviour.  |
