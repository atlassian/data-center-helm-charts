...
| jira.setPermissions | bool | `true` | Boolean to define whether to set home directory permissions on startup of Jira container. Set to 'false' to disable this behaviour. |
