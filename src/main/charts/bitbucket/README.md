...
![Version: 2.0.14](https://img.shields.io/badge/Version-2.0.14-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 10.2.7](https://img.shields.io/badge/AppVersion-10.2.7-informational?style=flat-square)
...
| bitbucket.mesh.image | object | `{"pullPolicy":"IfNotPresent","repository":"atlassian/bitbucket-mesh","tag":"4.2.5"}` | The Bitbucket Mesh image to use https://hub.docker.com/r/atlassian/bitbucket-mesh  |
...
| bitbucket.mesh.image.tag | string | `"4.2.5"` | The docker image tag to be used  |
