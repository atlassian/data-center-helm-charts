...
| bitbucket.mesh.image.repository | string | `"eivantsov/bitbucket-mesh"` | The Bitbucket Mesh Docker image to use https://hub.docker.com/r/atlassian/bitbucket-mesh  |
...
| bitbucket.mesh.port | int | `7777` | Bitbucket Mesh port  |
