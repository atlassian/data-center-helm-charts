...
| volumes.sharedHome.persistentVolumeClaim.resources | object | `{"requests":{"storage":"1Gi"}}` | Specifies the name of the persistent volume to claim |
...
| volumes.sharedHome.persistentVolumeClaim.volumeName | string | `nil` | Specifies the standard Kubernetes resource requests and/or limits for the shared-home volume claims. |
