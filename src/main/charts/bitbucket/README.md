...
![Version: 1.22.7](https://img.shields.io/badge/Version-1.22.7-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 9.4.4](https://img.shields.io/badge/AppVersion-9.4.4-informational?style=flat-square)
...
| bitbucket.mesh.image | object | `{"pullPolicy":"IfNotPresent","repository":"atlassian/bitbucket-mesh","tag":"3.4.2"}` | The Bitbucket Mesh image to use https://hub.docker.com/r/atlassian/bitbucket-mesh  |
...
| bitbucket.mesh.image.tag | string | `"3.4.2"` | The docker image tag to be used  |
